angular.module('starter.controllers', ['firebase'])
    ...
    .controller('AppCtrl', function($scope, $rootScope, $state, $ionicModal, $timeout, $http, $ionicPopup, $ionicLoading, LogFactory, appVersion, $localstorage, $firebaseArray,$firebaseAuth,$firebaseObject, base_url) {
        ...
        $scope.doLogin = function() {
            ...
            if ($rootScope.online) {
                ...
                // ===== INICIO CHAMADAS AUTH LOGIN FIREBASE =======
        ...
        $scope.doLogin = function() {
            ...
            var senha= $scope.loginData.password ;


            $scope.loginEmail(email,senha);
            $timeout(function() {
                $scope.closeLogin();
        ...
        $scope.loginEmail = function(email,senha) {
            ...
            firebase.auth()
                ...
                .then(function(result) {
                        ...
                        $scope.user=result.email;
                        console.log(" LOGADO sou o usuario : "+ $scope.user);
                        $state.go('inicio.app')
                    },
                    function(error) {
                        // colocar popupo
